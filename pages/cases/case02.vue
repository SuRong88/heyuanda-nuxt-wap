...
<template>
  <div class="case-page case-page02">
    ...
    <main>
      <div class="case-banner case-banner02 flex flex-center">
        ...
        <section class="sec sec03">
          ...
          <ul class="common-list01">
            <li class="list-item">
              ...
              <p class="item-txt">
                基于运营商大数据，从多个维度进行人群筛选。从多个维度获取客户，包括竞品维度、价值维度（付费行为）、平台相似度等等。
              </p>
            </li>
            <li class="list-item">
              <span class="label">
              ...
              <p class="item-txt">
                对品牌主过往投放广告的正样本进行监测，获取正样本后，上传至流量平台进行人群扩展。
              </p>
            </li>
          </ul>
        </section>
