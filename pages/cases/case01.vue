...
<template>
    <div class="case-page case-page01">
        ...
        <main>
            <div class="case-banner case-banner01 flex flex-center">
            ...
            <div class="content">
                ...
                <section class="sec sec02">
                    ...
                    <p class="txt">降低调研成本，提高调研覆盖范围和精准度，以及提高转化率。</p>
                </section>
                <section class="sec sec03">
                    <h2 class="con-tit">实施目标</h2>
                    <p class="tar-txt txt-center">通过聚客易产品的精准短信，实现以下目标：</p>
                    <ul class="common-list01">
                        <li class="list-item">
                            <span class="label">1</span>
                            <p class="item-txt">通过运营商大数据，基于客户个人属性（性别、年龄段、职业等），结合客户上网行为（安装和使用app、登陆官网等行为），精准定义人群。</p>
                        </li>
                        <li class="list-item">
                            <span class="label">2</span>
                            <p class="item-txt">通过运营商通道发送短信，精准触达人群。</p>
                        </li>
                        <li class="list-item">
                            <span class="label">3</span>
                            <p class="item-txt">数据脱敏加密，保护客户个人隐私。</p>
                        </li>
                    </ul>
                </section>
                <section class="sec sec04">
                    <h2 class="con-tit">实施成效</h2>
                    <p class="effect-txt"></p>
