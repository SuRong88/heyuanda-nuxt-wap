...
<template>
    <div class="case-page case-page04">
        ...
        <main>
            <div class="case-banner case-banner04 flex flex-center">
            ...
            <div class="content">
                ...
                <section class="sec sec01">
                    ...
                    <p class="txt">某广告监测平台，过往通过虚拟机或SDK获得广告素材，存在素材收集不全，广告曝光、点击、转化数据皆依赖抽样，无法准确量化等问题。</p>
                </section>
                <section class="sec sec02">
                    <h2 class="con-tit">客户需求</h2>
                    <p class="txt">全面收集广告素材，对营销漏斗各个环节进行量化。</p>
                </section>
                <section class="sec sec03">
                    <h2 class="con-tit">实施目标</h2>
                    <p class="tar-txt">基于运营商大数据，对广告素材进行监测。</p>
