...
<template>
  <div class="case-page case-page09">
    ...
    <main>
      <div class="case-banner case-banner08 flex flex-center">
      ...
      <div class="content">
        <section class="sec sec01">
          ...
          <p class="txt">
            随着业务的快速发展，业务支撑系统规模的不断扩大，承载业务种类繁杂，业务量巨大。为了确保NGCRM系统高效稳定运行，并构筑和完善性能容量模型，该运营商开展了" NGCRM系统性能管控支持服务项目"。
          </p>
        </section>
        ...
        <section class="sec sec03">
          ...
          <ul class="common-list01">
            ...
            <li class="list-item">
              ...
              <p class="item-txt">
                性能基础管理：包括系统的业务/服务/IT部件容量基础数据的采集、监控、分析、问题提出及优化建议、问题管理等工作。
              </p>
            </li>
            <li class="list-item">
              <span class="label">
              ...
              <p class="item-txt">
                构筑和完善性能容量模型：分析并构筑业务容量模型，逐步完善性能容量模型，为后续的扩容和优化提供参考依据。
              </p>
            </li>
            <li class="list-item">
              <span class="label">
              ...
              <p class="item-txt">
                预测系统性能和容量状况，对未来可能出现的性能瓶颈和容量不足发出告警，以便提前做好应对措施。
              </p>
            </li>
          </ul>
        </section>
        <section class="sec sec04">
          ...
          <ul class="common-list02">
            <li class="list-item">
              ...
              <p class="item-txt">
                建立了端对端的性能管理体系，能够快速准确定位性能问题，直接给出优化建议，以便快速解决性能问题。
              </p>
            </li>
            <li class="list-item">
              <img class="item-img" src="@/assets/images/case/img20.jpg" alt="" />
              <p class="item-txt">
                构建了性能容量评估模型，将业务数据与性能数据关联起来，为系统业务支撑能力评估、系统性能优化、系统扩容等工作提供参考依据和决策支撑。
              </p>
            </li>
            <li class="list-item">
              <img class="item-img" src="@/assets/images/case/img21.jpg" alt="" />
              <p class="item-txt">
                目前该系统监控设备达到50多台，包括数据库服务器、应用服务器和Web服务器等。
              </p>
            </li>
          </ul>
        </section>
