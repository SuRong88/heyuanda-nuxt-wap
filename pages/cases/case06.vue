...
<template>
  <div class="case-page case-page06">
    ...
    <main>
      <div class="case-banner case-banner06 flex flex-center">
      ...
      <div class="content">
        ...
        <section class="sec sec03">
          ...
          <p class="tar-txt">
            基于运营商大数据，对粉丝真实活跃情况进行监测，还原真实粉丝数量，并对粉丝群体进行画像。
          </p>
        ...
        <section class="sec sec04">
          ...
          <ul class="common-list02">
            ...
            <li class="list-item">
              ...
              <p class="item-txt">
                找出真实粉丝数量，结合精准投放，避免无效广告投放，节省广告成本，提高转化收益。
              </p>
            </li>
          </ul>
        </section>
