...
<template>
    <div class="case-page case-page08">
        ...
        <main>
            <div class="case-banner case-banner10 flex flex-center">
            ...
            <div class="content">
                ...
                <section class="sec sec03">
                    ...
                    <p class="tar-txt txt-center">为客户WEB应用提供如下安全防护能力:</p>
                    <ul class="common-list01">
                        <li class="list-item">
                            <span class="label">1</span>
                            <p class="item-txt">网站代码防护能力：采用URL动态封装技术，隐藏应用攻击入口，保护网站源码。</p>
                        </li>
                        <li class="list-item">
                            <span class="label">2</span>
                            <p class="item-txt">自动化攻击防护能力：采用客户端动态验证技术，阻止自动化攻击。</p>
                        </li>
                        <li class="list-item">
                            <span class="label">3</span>
                            <p class="item-txt">用户信息防护能力：采用客户端请求动态混淆技术，保护终端请求，过滤用户敏感信息。</p>
                        </li>
                        <li class="list-item">
                            <span class="label">4</span>
                            <p class="item-txt">业务逻辑防护能力：访问请求动态令牌技术，保障请求访问的唯一性，保障业务逻辑。</p>
                        </li>
                    </ul>
                </section>
                <section class="sec sec04">
                    ...
                    <p class="effect-txt">
                        随着RAS动态应用防护系统的建成并投入使用，大大提高了该省运营商电子渠道WEB应用防护能力。
                        <br />
                        有效阻断拦截了自动化工具攻击、安全渗透、撞库、薅羊毛等针对性外部攻击，达到了客户预期目标。
                    </p>
