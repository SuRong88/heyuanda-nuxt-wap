...
<template>
  <div class="case-page case-page03">
    ...
    <main>
      <div class="case-banner case-banner03 flex flex-center">
      ...
      <div class="content">
        ...
        <section class="sec sec02">
          ...
          <p class="txt">
            降低数据采集风险，减少样本偏差，能及时地获取到稳定、准确的基础数据。
          </p>
        </section>
        <section class="sec sec03">
          ...
          <ul class="common-list01">
            <li class="list-item">
              ...
              <p class="item-txt">
                基于运营商大数据，通过DPI等技术实现业务行为的识别，包括APP和小程序的识别、监测，为该公司提供基础数据服务。
              </p>
            </li>
            <li class="list-item">
              <span class="label">
