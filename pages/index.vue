<template>
  <div class="index-page" :class="{ lastScreen: screenIndex == 4 }">
        ...
        <swiper-slide class="index-swiper-item index-swiper-item04" :class="{ active: watchMaxIndex >= 3 }">
          <div class="item-inner">
            ...
            <div class="inner-bottom">
              ...
              <div class="sub-swiper-box">
                <swiper class="index-sub-swiper" :options="swiperSubOption" ref="indexSubSwiper">
                  <swiper-slide v-if="currentSubList.length" v-for="(item, index) in currentSubList" class="sub-swiper-item flex flex-align-center">
    ...
    <div class="slide-down" v-show="screenIndex != 4"><img class="icon-down-more" src="@/assets/images/index/arrow.png"
        alt="" /></div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    mounted() {
      // this.indexSubSwiper.init()
      // this.watchMaxIndex = 0;
    },
    data() {
      let that = this;
      return {
    ...
    methods: {
      ...
      navSwitch(index) {
        ...
        this.indexSubSwiper.update();
        // this.indexSubSwiper.update();
        // this.indexSubSwiper.updateSlides();
        // 对于loop:false=>0,loop:true=>1
        this.indexSubSwiper.slideTo(0);
      }
    },
    beforeDestroy() {},
    // 注意，这个生命周期没有this
